...
#      - CORE_VM_DOCKER_HOSTCONFIG_NETWORKMODE=ingress
...
#      - ingress
#      - byfn
oborysenko@ip-172-17-2-237:~/hyperledger/fabric-samples/first-network$
oborysenko@ip-172-17-2-237:~/hyperledger/fabric-samples/first-network$
oborysenko@ip-172-17-2-237:~/hyperledger/fabric-samples/first-network$
oborysenko@ip-172-17-2-237:~/hyperledger/fabric-samples/first-network$
oborysenko@ip-172-17-2-237:~/hyperledger/fabric-samples/first-network$
oborysenko@ip-172-17-2-237:~/hyperledger/fabric-samples/first-network$ cat scripts/script.sh
#!/bin/bash
